...
bool DoublyLinkedListTest::test5()
{
    ...
    ASSERT_TRUE(list.insert_back(300))
    ASSERT_TRUE(list.replace(0, 400))
    ASSERT_TRUE(list.replace(1, 500))
    ASSERT_TRUE(list.replace(2, 600))

    ASSERT_TRUE(list.select(0) == 400 && list.select(1) == 500 && list.select(2) == 600)
